...
<li {{ $attributes->class(['inline-flex w-64 flex-col text-center lg:w-auto' ]) }}>
    <div class="max-w-md w-full bg-gray-900 shadow-lg rounded-xl p-6">
        ...
        <div class="">
            <div class="relative h-62 w-full mb-3">
                ...
                <img src=" {{ asset('images/products/'. $product->image)}}" alt="Goat Milk" class=" w-full object-center object-fill rounded-2xl">
            </div>
        ...
        <div class="max-w-md w-full bg-gray-900 shadow-lg rounded-xl p-6">
            ...
            <div class="">
                <div class="relative h-62 w-full mb-3">
                    ...
                    <img src=" {{asset('images/products/goatmilktreat.jpeg')}}" alt="Goat Milk" class=" w-full object-center object-fill rounded-2xl">
                </div>
                <div class="flex-auto justify-evenly">
                <div class="flex flex-wrap ">
                    <div class="w-full flex-none text-sm flex items-center text-gray-600">
...
<img class="h-48 w-full object-cover object-center" src="https://images.unsplash.com/photo-1577982787983-e07c6730f2d3?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2059&q=80" alt="Just a flower" class=" w-full   object-fill  rounded-2xl">
