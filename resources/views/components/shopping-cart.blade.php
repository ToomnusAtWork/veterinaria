...
<div x-ref="popover"
    ...
    <div x-ref="popoverInner" x-data="{ cart:[], addToCart(product){
        this.cart.push(product);
    }}" 
        x-show="popoverOpen" class="w-full p-4 bg-white border rounded-md shadow-sm border-neutral-200/70">
