    ...
    <div class="container mx-auto px-4">
      <div class="mb-5">
        <div class="block mb-1">
          <label for="datepicker" class="font-bold text-gray-700 flex">Select Appointment Date</label>
        </div>
        <div class="relative">
          ...
          <div class="bg-white mt-12 rounded-lg shadow p-4 absolute top-0 left-0 z-10" style="width: 25rem" x-show.transition="showDatepicker" @click.away="showDatepicker = false">
