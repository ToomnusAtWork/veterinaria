...
@section('content')
    <div class="bg-gray-100 py-8" x-data="{ showCheckoutConfirmation: false }">
        <div class="container  mx-auto px-4 md:w-11/12">
            <h1 class="text-2xl font-semibold mb-4">Your Basket</h1>
                                        ...
                                        <tr>
                                            <td class="py-4">
                                                <div class="flex items-center">
                                                    <img class="h-16 w-16 mr-4" src="{{ '/storage/' . $service->image }}"
                                            ...
                                            <form
                                                ...
                                                <td class="py-4">
                                                    <button type="submit"
                                                        class="text-red-500 hover:text-red-600 font-semibold">Remove</button>
                                                </td>
                                            </form>
                ...
                <div class="md:w-1/4">
                    <div class="bg-white rounded-lg shadow-md p-6">
                        ...
                        <div class="mt-4 w-full">
                            <a href="{{ route('cart') }}" class="block text-center bg-blue-500 text-white py-3 px-4 rounded-lg  w-full">Checkout</a>
                        </div>
                    </div>
                </div>
            </div>
