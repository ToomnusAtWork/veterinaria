    ...
    <div class="lg:ml-[280px] relative h-full max-h-screen rounded-xl transition-all duration-200 bg-white">
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 px-4 gap-4">
            ...
            <div
                ...
                <div
                    ...
                    @if ($percentageRevenueChangeLastMonth >= 0)
                        <svg fill="#9d174d" width="30" height="30" viewBox="0 0 24 24" id="up-trend-round"
                            ...
                            <path id="primary" d="M21,7l-6.79,6.79a1,1,0,0,1-1.42,0l-2.58-2.58a1,1,0,0,0-1.42,0L3,17"
                                style="fill: none; stroke:rgb(157, 23, 77); stroke-linecap: round; stroke-linejoin: round; stroke-width: 2;" />
                            <polyline id="primary-2" data-name="primary" points="21 11 21 7 17 7"
                                style="fill: none; stroke: rgb(157, 23, 77); stroke-linecap: round; stroke-linejoin: round; stroke-width: 2;" />
                            <script xmlns="" />
                        </svg>
                    @else
                        <svg fill="#9d174d" width="30" height="30" viewBox="0 0 24 24" id="down-trend"
                            data-name="Flat Line" xmlns="http://www.w3.org/2000/svg" class="icon flat-line">
                            <polyline id="primary" points="3 6 11 14 14 11 21 18"
                                style="fill: none; stroke: rgb(157, 23, 77); stroke-linecap: round; stroke-linejoin: round; stroke-width: 2;">
                            </polyline>
                            <polyline id="primary-2" data-name="primary" points="17 18 21 18 21 14"
                                style="fill: none; stroke: rgb(157, 23, 77); stroke-linecap: round; stroke-linejoin: round; stroke-width: 2;">
                            </polyline>
                        </svg>
                    @endif
            ...
            <div
                ...
                <div
                    class="flex justify-center items-center w-14 h-14 bg-white rounded-full transition-all duration-300 transform group-hover:rotate-12">
                    <svg width="30" height="30" fill="none" viewBox="0 0 17 17" stroke="currentColor"
                        class="stroke-current text-blue-800  transform transition-transform duration-500 ease-in-out">
                        <path
