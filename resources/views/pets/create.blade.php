@extends('layouts.app', ['title' => 'Pet Information'])
...
<div class="w-full max-w-7xl mx-auto p-8">
    ...
    <form>
        <div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
            <div>
                ...
                <div class="mt-2 flex justify-center px-6 py-32 border-2 border-gray-300 border-dashed rounded-md">
                    <div class="space-y-1 text-center">
                        <svg class="mt-2 mx-auto h-16 w-16 text-gray-600" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="mx-5">ทางระบบอยากให้กรอกข้อมูลส่วนตัวของสัตว์เลี้ยงเบื้องต้นเพื่อสามารถเก็บเป็นข้อมูลและวินิจฉัยถัดๆไป</div>

            <div>
                <label class="text-black dark:text-gray-200" for="username">Pet name</label>
                <input id="username" type="text"
                    class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring">
            </div>

            <div>
                <label class="text-black dark:text-gray-200" for="emailAddress">Date Of Birth</label>
            ...
            <div>
                <label class="text-black dark:text-gray-200" for="passwordConfirmation">Select Animal Type</label>
                <select
                    class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring">
                    <option>Dog</option>
                    <option>Cat</option>
            ...
            <div>
                <label class="text-black dark:text-gray-200" for="passwordConfirmation">Select Animal Breed</label>
                <select
                    class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring">
                    <option>Male</option>
                    <option>Female</option>
            ...
            <div class="col-span-2">
                <label class="text-black dark:text-gray-200" for="username">Allergen</label>
                <input id="username" type="text"
                    class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring">
            </div>

            <div class="col-span-2">
                <label class="text-black dark:text-gray-200" for="passwordConfirmation">Note</label>
                <textarea id="textarea" type="textarea"
                    class="block w-full px-4 py-10 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring"></textarea>
            </div>
        </div>

        <div class="flex justify-end mt-6 space-x-3">
            <button class="bg-zinc-100 px-4 rounded">cancel</button>
            <button
