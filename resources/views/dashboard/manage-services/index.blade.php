...
@section('content')
   ...
   <div class="ml-[300px]">
      ...
      <div class="flex justify-between mx-7">
          ...
          <a href="{{ route('manage-service.create') }}" class="px-5 py-2 text-white bg-blue-500 rounded-md hover:bg-blue-600">
            Create
        </a>
      </div>
      <div class="mt-4">
          ...
          <table class="w-full border-collapse bg-white text-left text-sm text-gray-500 overflow-x-scroll min-w-screen">
            ...
            <tbody class="divide-y divide-gray-100 border-t border-gray-100">
              ...
              <tr class="hover:bg-gray-50">
                  ...
                  <td>
                      <div class="mt-5 ">
                          <a href="{{ route('manage-service.show', ['service' => $service]) }}">
                                        <x-button>
                                            {{ __('View') }}
                                        </x-button>
                            </a>
                            <a href="{{ route('manage-service.edit', ['service' => $service]) }}">
                                <x-warning-button >
                                    {{ __('Edit') }}
                                </x-warning-button>
                            </a>
                            <a href="{{ route('manage-service.delete', ['service' => $service])  }}">
                                <x-danger-button>
                                    {{ __('Delete') }}
                                </x-danger-button>
                            </a>
