@extends('layouts.privileged', ['title' => 'Manage User'])
        ...
        <div class="ml-[300px] overflow-auto rounded-lg border border-gray-200 shadow-md m-5">
            ...
            <form class="w-1/3 float-right m-4" action="{{ route('manageusers') }}">
                ...
                <div class="relative">
                    ...
                    <button type="submit"
                        class="text-white absolute right-2.5 bottom-2.5 bg-blue-600 hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2">Search</button>
                </div>
            </form>
