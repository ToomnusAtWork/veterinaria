    ...
    <form wire:submit.prevent="submit">
        ...
        <div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
            ...
            <div>
                ...
                <input type="text" wire:model="quantity" id="quantity" class="block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
