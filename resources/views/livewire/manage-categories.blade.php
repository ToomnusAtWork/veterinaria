<div class='ml-[300px]'>
    <div>
        <div class="flex justify-between mx-7">
            ...
            <x-button wire:click="confirmCategoryAdd"  class="px-5 py-2 text-white bg-blue-500 rounded-md hover:bg--600">
                Create
            </x-button>
        </div>
        <div class="mt-4">
            ...
            <x-dialog-modal wire:model="confirmingCategoryAdd">
                ...
                <x-slot name="content">
                    <div>
                        ...
                        <input type="text" wire:model="category.name" id="name" class="block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
